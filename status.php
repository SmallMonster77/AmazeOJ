...
if($OJ_TEMPLATE!="classic") 
	$judge_color=Array("am-btn am-btn-default am-round am-btn-sm",
                        "am-btn am-btn-primary am-round am-btn-sm",
                        "am-btn am-btn-warning am-round am-btn-sm",
                        "am-btn am-btn-warning am-round am-btn-sm",
                        "am-btn am-btn-success am-round am-btn-sm",
                        "am-btn am-btn-danger am-round am-btn-sm",
                        "am-btn am-btn-danger am-round am-btn-sm",
                        "am-btn am-btn-warning am-round am-btn-sm",
                        "am-btn am-btn-warning am-round am-btn-sm",
                        "am-btn am-btn-warning am-round am-btn-sm",
              ...
              if(!$lock||$lock_time>$row['in_date']||$row['user_id']==$_SESSION['user_id']){
                if($OJ_SIM&&$row['sim']>80&&$row['sim_s_id']!=$row['s_id']) {
                        ...
                        if( isset($_SESSION['source_browser'])){
                                        ...
                                        $view_status[$i][3].= "<a href=comparesource.php?left=".$row['sim_s_id']."&right=".$row['solution_id']."  class='am-btn am-btn-primary'  target=original>".$row['sim_s_id']."(".$row['sim']."%)</a>";
                        }else{
